...
- /homer review &lt;search&gt; - Share a merge request on a channel. Searches in title and description by default. Accepts IDs prefixed with "!".
- /homer review list - List ongoing reviews shared in a channel.

Don't hesitate to join me on #moes-tavern to take a beer!`,
    blocks: [
      {
        type: 'section',
        text: {
