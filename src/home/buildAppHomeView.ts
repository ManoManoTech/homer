...
import { GITLAB_URL, MOES_TAVERN_CHANNEL_ID } from '@/constants';
...
:gitlab: <${GITLAB_URL}/spartacux-front/homer | Gitlab project>
:books: <${GITLAB_URL}/spartacux-front/homer/-/blob/master/README.md | Documentation>
:bug: <${GITLAB_URL}/spartacux-front/homer/-/issues | Issues>
